...
public class Main : MonoBehaviour
{
    ...
    int feature1__Test_Working;
    int feature1__Program_Working;
    int feature2__Program_Working;
    ...
    public TMP_Text F2C_UI;
    public TMP_Text F3C_UI;
    public TMP_Text F4C_UI;
    public TMP_Text F5C_UI;
    ...
    public void Select_Feature_Test()
    {
        if (vacant_feature1_Test)
        {
            ...
            if(feature1__Test_Working==1){
                 ProgramingFeature2.GetComponent<Image>().sprite = Feature1;
            }
            if(feature1__Test_Working==2){
                 ProgramingFeature2.GetComponent<Image>().sprite = Feature2;
            }
        ...
        else
        {
            ...
            if(feature1__Test_Working==1){
                 TestingFeature2.GetComponent<Image>().sprite = Feature1;
            }
            if(feature1__Test_Working==2){
                 TestingFeature2.GetComponent<Image>().sprite = Feature2;
            }
    ...
    void Programming_Feature()
    {
        //     if((selectProgrammer1|| selectProgrammer2|| selectProgrammer3|| selectProgrammer4) &&selectDesign)
        {
            ...
            if (time_feature2_Program == 0)
            {
                if(feature1__Program_Working==1){
                    F1_count++;
                    if (F1_count > 3)
                    {
                    F1C_UI.text = "3/3";
                ...
                if(feature1__Program_Working==2){
                    F2_count++;
                    if (F2_count > 3)
                    {
                    F2C_UI.text = "3/3";
                    ...
                    {
                    F2C_UI.text = F2_count + "/3";
                    }
                }
                if(feature1__Program_Working==3){
                    F3_count++;
                    if (F3_count > 3)
                    {
                    F3C_UI.text = "3/3";
                    ...
                    {
                    F3C_UI.text = F3_count + "/3";
                    }
                }
                if(feature1__Program_Working==4){
                    F4_count++;
                    if (F4_count > 3)
                    {
                    F4C_UI.text = "3/3";
                    ...
                    {
                    F4C_UI.text = F4_count + "/3";
                    }
                }
                if(feature1__Program_Working==5){
                    F5_count++;
                    if (F5_count > 3)
                    {
                    F5C_UI.text = "3/3";
